...
function archetype_enqueue_bootstrap() {
	...
	if ( !defined('ARCHETYPE_ENQUEUE') ) {
		...
		wp_register_style( 'bootstrap-latest', '//netdna.bootstrapcdn.com/bootstrap/3.1.1/css/bootstrap.min.css' );
		wp_enqueue_style( 'bootstrap-latest' );

		wp_register_script( 'bootstrap-latest', '//netdna.bootstrapcdn.com/bootstrap/3.1.1/js/bootstrap.min.js', array( 'jquery' ) );
